...
Below are Regenerons historical revenue statistics, and forecast revenue taken from a consensus of financial analysts.
...
As such, we'll analyze the impacts to forecast future cash flows based upon exposure to the following currencies:
...
cash_flow_setup <- ex_paths |> 
  ...
  mutate(rev_current_daily_sim_aud = (rev_current_daily_aud*exchange_rate_current_aud)/simulated_rate_aud,
         rev_current_daily_sim_cad = (rev_current_daily_cad*exchange_rate_current_cad)/simulated_rate_cad,
         rev_current_daily_sim_cny = (rev_current_daily_cny*exchange_rate_current_cny)/simulated_rate_cny,
         rev_current_daily_sim_eur = (rev_current_daily_eur*exchange_rate_current_eur)/simulated_rate_eur,
         rev_current_daily_sim_gbp = (rev_current_daily_gbp*exchange_rate_current_gbp)/simulated_rate_gbp,
         rev_current_daily_sim_jpy = (rev_current_daily_jpy*exchange_rate_current_jpy)/simulated_rate_jpy) |> 
